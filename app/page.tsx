...
export default function Home() {
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-muted-foreground sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            AITrack is a powerful VS Code extension that helps you write better
            code faster. Get real-time AI-powered suggestions and insights as
            you code.
          </p>
          <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
            <div className="rounded-md shadow">
              <Link
                href={externalLinks.aitrack}
                target="_blank"
          ...
          <div className="mt-12 space-y-10">
            <div className="relative">
              ...
              <ul className="mt-2 ml-4 list-disc list-inside text-base text-secondary-foreground">
                ...
                <li>
                  Go to the Extensions Marketplace (Ctrl+Shift+X or
                  Cmd+Shift+X).
                </li>
                <li>
                  Search for &quot;AiTrack&ldquo; and click &quot;Install.&quot;
                </li>
              </ul>
              <p className="mt-2 text-base text-secondary-foreground">
                ...
                >
                  AiTrack from VS Code Marketplace
                </a>
              </p>
            </div>
            <div className="relative">
              ...
              <p className="mt-2 text-base text-secondary-foreground">
                The extension will automatically handle GitHub authentication
                when needed.
              </p>
            </div>
            <div className="relative">
              <h3 className="text-lg leading-6 font-medium text-secondary-foreground">
                3. Choose your tracking preferences
              </h3>
              <p className="mt-2 text-base text-secondary-foreground">
  ...
  "aitrack.repoVisibility": "private"
            ...
            <div className="relative">
              ...
              <ul className="mt-2 ml-4 list-disc list-inside text-base text-secondary-foreground">
                <li>
                  Tracking will start automatically once the extension is
                  active.
                </li>
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-base text-secondary-foreground">
                Visit your tracking repository on GitHub to see your logs,
                AI-generated commit messages, and detailed diffs.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                description:
                  "Get intelligent code suggestions as you type, helping you write better code faster.",
                icon: (
                  <svg
              ...
              },
              {
                ...
                description:
                  "Identify potential issues and optimize your code on the fly.",
                icon: (
                  <svg
                    className="absolute h-6 w-6 text-green-500"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              },
              {
                ...
                description:
                  "Works with a wide range of programming languages and frameworks.",
                icon: (
                  <svg
                    className="absolute h-6 w-6 text-green-500"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              },
              {
                ...
                description:
                  "Tailor AITrack to your specific needs and coding style.",
                icon: (
                  <svg
                    className="absolute h-6 w-6 text-green-500"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              },
              {
                ...
                description:
                  "Lightweight extension that won't slow down your development environment.",
                icon: (
                  <svg
                    className="absolute h-6 w-6 text-green-500"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              },
              {
                ...
                description:
                  "Benefit from continuous improvements and new features.",
                icon: (
                  <svg
                    className="absolute h-6 w-6 text-green-500"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                key={feature.name}
                className="relative p-6 bg-secondary rounded-lg shadow-sm hover:shadow-md transition duration-300"
              >
                <dt>
                  <div className="absolute left-6 top-6">{feature.icon}</div>
                  <p className="ml-9 text-lg leading-6 font-medium text-foreground">
                    {feature.name}
                  </p>
                </dt>
                <dd className="mt-2 ml-9 text-base text-muted-foreground">
                  {feature.description}
                </dd>
              </div>
            ))}
